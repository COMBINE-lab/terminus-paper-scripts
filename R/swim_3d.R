...
mm <- readr::read_csv(file.path(result.dir,"mmcollapse_truth_1_1"))


combineDF <- function(a,b,c,names=c("A","B","C")) {
  data.frame(y=c(a$salmon_1, b$mercury_1, c$mmcollapse_1),
             x=c(a$sample_01, b$sample_01, c$sample_01),
